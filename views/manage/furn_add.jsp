    ...
    <script type="text/javascript">
        ...
        $(function (){
            ...
            $("#submit01").click(function (){
                ...
                var pricePattern=/^([1-9]+0*|0)(\.\d{0,2})?$/
                var numPattern=/^(([1-9]+0*){1,11}|0)$/
                if (!pricePattern.test(priceVal)){
                    $("#point").text("价格格式错误..")
                    return false;
                }
                if (!(numPattern.test(salesVal)&&numPattern.test(stockVal))){
                    $("#point").text("销量或库存格式错误..")
                    return false;
                }
                return true;
            })
...
<div class="cart-main-area pt-100px pb-100px">
    <div class="container">
        ...
        <div class="row">
            <span type="hidden" style="float: right;color: gray;text-align: right;font-weight: bold;font-size: 20px"  id="point" >${requestScope.mes}</span>
            <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                <form action="manage/furnServlet?action=addFurn&pageNow=${param.pageNow}" method="post" enctype="multipart/form-data">
                    <%--<input type="hidden" name="action" value="addFurn">--%>
                    <%--&lt;%&ndash;增加一个隐藏域 pageNow&ndash;%&gt;--%>
...
<!--                                    <a href="#"><i class="icon-close"></i></a>-->
                                    <input id="submit01" type="submit" style="width: 90%;background-color: silver;border: silver;border-radius: 20%;" value="添加家居"/>
                                </td>
                            </tr>
                            </tbody>
                        </table>
